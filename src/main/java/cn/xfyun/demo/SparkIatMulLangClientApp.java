 ...
 * 1、APPID、APISecret、APIKey信息获取：https://console.xfyun.cn/services/bmm
 * 2、文档地址：https://www.xfyun.cn/doc/spark/spark_mul_cn_iat.html
 */
public class SparkIatMulLangClientApp {
    ...
    private static String filePath = "audio/spark_iat_mul_lang_16k_10.pcm";
    private static String resourcePath;

    static {
        try {
            resourcePath = SparkIatMulLangClientApp.class.getResource("/").toURI().getPath();
    ...
    public static void main(String[] args) throws FileNotFoundException, SignatureException, MalformedURLException {
        SparkIatClient sparkIatClient = new SparkIatClient.Builder()
                .mulLanguage(SparkIatModelEnum.MUL_CN_MANDARIN.getCode())
