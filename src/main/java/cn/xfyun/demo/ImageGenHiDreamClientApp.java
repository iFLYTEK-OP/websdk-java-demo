 ...
 * 1、APPID、APISecret、APIKey信息获取：https://console.xfyun.cn/services/hidream
 * 2、文档地址：https://www.xfyun.cn/doc/spark/hidream.html
 */
public class ImageGenHiDreamClientApp {
    ...
    static {
        try {
            // 图片基路径
            resourcePath = ImageGenHiDreamClientApp.class.getResource("/").toURI().getPath();
            // 参考图片的路径
